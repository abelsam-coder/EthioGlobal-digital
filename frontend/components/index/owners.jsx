    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div
          className={`absolute inset-0 ${
            isDark
              ? 'opacity-[0.02] bg-[linear-gradient(rgba(255,255,255,0.1)_1px_1px_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.1)_1px_1px,transparent_1px)] bg-[size:50px_50px]'
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-5 sm:px-6 lg:px-8">
        ...
        >
          ...
          <a
            href="#contact"
            className="group inline-flex items-center gap-3 px-8 py-4 rounded-2xl font-bold text-white transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl hover:shadow-violet-500/25"
