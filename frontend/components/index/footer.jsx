...
function LegalModal({ isOpen, onClose, title, content }) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div
        className="relative w-full max-w-2xl max-h-[80vh] bg-[#0a0a0a]/95 backdrop-blur-xl border border-white/[0.08] rounded-2xl shadow-2xl shadow-black/60 flex flex-col overflow-hidden animate-[fadeSlideIn_0.3s_ease-out]"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Header */}
        <div className="relative flex items-center justify-between px-6 py-5 border-b border-white/[0.06] bg-[#0d0d12]/80 flex-shrink-0">
          ...
          <div>
            ...
            <p className="text-xs text-neutral-500 mt-0.5">Last updated: January 2025</p>
          </div>
          <button
            onClick={onClose}
            className="w-9 h-9 rounded-lg flex items-center justify-center text-neutral-500 hover:text-white hover:bg-white/[0.06] transition-all duration-200 flex-shrink-0"
          >
              ...
              <ul className="space-y-2.5">
                {section.items.map((item, i) => (
                  <li key={i} className="flex gap-3">
                    <span className="w-1 h-1 rounded-full bg-blue-500/40 flex-shrink-0 mt-2" />
        ...
        {/* Footer */}
        <div className="px-6 py-4 border-t border-white/[0.06] bg-[#0d0d12]/60 flex-shrink-0">
          <button
            onClick={onClose}
            className="w-full py-2.5 text-sm font-medium text-neutral-400 hover:text-white rounded-xl border border-white/[0.08] hover:border-white/15 hover:bg-white/[0.03] transition-all duration-300"
          >
            Close
          </button>
        </div>
    ...
    <>
      <footer className="relative bg-[#030304] border-t border-white/[0.04]">
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          <div className="absolute bottom-0 left-1/4 w-[400px] h-[400px] bg-blue-600/[0.03] rounded-full blur-[150px]" />
          <div className="absolute bottom-0 right-1/4 w-[300px] h-[300px] bg-purple-600/[0.03] rounded-full blur-[120px]" />
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 pt-16 pb-8">
            ...
            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-10">
              ...
              <div className="flex flex-col gap-5 max-w-md">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-lg font-bold text-white tracking-tight">Agency</span>
                </div>
                ...
                <div className="flex items-center gap-2.5">
                  {socials.map((social) => (
                    <a
                      ...
                      className="w-9 h-9 rounded-lg bg-white/[0.04] border border-white/[0.06] flex items-center justify-center text-neutral-500 hover:text-white hover:border-white/15 hover:bg-white/[0.08] transition-all duration-300"
                    >
                      {social.icon}
                    </a>
                  ))}
                ...
                <div className="flex flex-col gap-2 pt-1">
                  <a href="tel:+251912345678" className="flex items-center gap-2 text-sm text-neutral-500 hover:text-blue-400 transition-colors duration-300 w-fit">
                    <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" />
                    </svg>
                    +251 912 345 678
                  </a>
                  <a href="mailto:info@agency.com" className="flex items-center gap-2 text-sm text-neutral-500 hover:text-blue-400 transition-colors duration-300 w-fit">
                    <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              {/* Services List */}
              <div>
                <h5 className="text-xs font-semibold text-white uppercase tracking-wider mb-5 flex items-center gap-2">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8 py-12 border-b border-white/[0.06]">

            {/* Company */}
            <div>
              <h5 className="text-xs font-semibold text-white uppercase tracking-wider mb-5 flex items-center gap-2">
                <span className="w-5 h-px bg-purple-500/50" />
                Company
              </h5>
              <ul className="flex flex-col gap-3">
                {footerLinks.company.map((link) => (
                  <li key={link.label}>
                    <a href={link.href} className="text-sm text-neutral-500 hover:text-white transition-colors duration-300 w-fit">
                      {link.label}
                    </a>
                  </li>
                ))}
                ...
                {footerLinks.legal.map((link) => (
                  <li key={link.label}>
                    <button
                      ...
                      className="text-sm text-neutral-500 hover:text-white transition-colors duration-300 w-fit"
                    >
                      {link.label}
                    </button>
                  </li>
            ...
            <div className="col-span-2 md:col-span-1">
              <h5 className="text-xs font-semibold text-white uppercase tracking-wider mb-5 flex items-center gap-2">
                <span className="w-5 h-px bg-amber-500/50" />
                Working Hours
              </h5>
              <ul className="flex flex-col gap-3">
                {[
                  ...
                  <li key={item.day} className="flex items-center justify-between gap-4">
                    ...
                    <span className={`text-sm font-medium ${item.time === 'Closed' ? 'text-red-400/60' : 'text-neutral-300'}`}>
                      {item.time}
                    </span>
                  </li>
                ))}
              ...
              <div className="mt-5 flex items-center gap-2 px-3 py-2 rounded-lg bg-white/[0.02] border border-white/[0.04] w-fit">
                <span className="relative flex h-2 w-2">
                  <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75" />
                  <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-500" />
                </span>
                <span className="text-[11px] font-medium text-emerald-400">Online Support 24/7</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-8">
            ...
            <div className="flex items-center gap-1.5">
              <span className="text-[10px] text-neutral-700 uppercase tracking-wider">Powered by</span>
            ...
            <button
              ...
              className="group flex items-center gap-2 text-xs text-neutral-600 hover:text-white transition-colors duration-300"
            >
              Back to top
              <div className="w-7 h-7 rounded-lg border border-white/[0.06] flex items-center justify-center group-hover:border-white/15 group-hover:bg-white/[0.04] transition-all duration-300">
