    ...
    <>
          ...
          <div className="max-w-7xl mx-auto px-4 py-2.5 sm:py-3 flex items-center justify-between">
            <div className="flex items-center gap-3 sm:gap-4 flex-1">
              ...
              >
                ...
                <span className="text-xs sm:text-sm font-bold tracking-wide">LIMITED OFFER</span>
              </div>
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              <a
                ...
                className={`hidden sm:flex items-center gap-2 px-5 py-2 rounded-full text-sm font-bold transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl ${
                  isDark ? 'bg-white text-gray-900 hover:bg-gray-100' : 'bg-emerald-500 text-white hover:bg-emerald-600'
                }`}
              >
              ...
              <button
                ...
                className={`flex items-center justify-center w-8 h-8 rounded-full transition-all duration-300 hover:rotate-90 ${
                  isDark ? 'bg-white/10 hover:bg-white/20 text-white' : 'bg-black/5 hover:bg-black/10 text-gray-600'
                }`}
      ...
      <nav
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ease-out ${
          showBanner ? 'top-10 sm:top-11' : 'top-0'
        } ${scrolled ? 'py-1.5 sm:py-2.5 shadow-lg shadow-black/10' : 'py-3 sm:py-4'}`}
        style={{
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-14 sm:h-16 lg:h-[76px]">
          ...
          >
            <img
              ...
              className={`h-9 sm:h-10 w-auto object-contain rounded-lg transition-all duration-300 group-hover:scale-105 ${
                isTransitioning ? 'opacity-0 scale-95 rotate-12' : 'opacity-100 scale-100 rotate-0'
              }`}
            />
            <div className="hidden lg:flex flex-col leading-none">
              <span className={`font-bold text-base xl:text-lg tracking-tight transition-colors duration-300 ${isDark ? 'text-white' : 'text-gray-900'}`}>
                EthioGlobal Digital
              </span>
              <span className={`text-xs font-semibold uppercase tracking-[0.15em] mt-0.5 transition-colors duration-300 ${isDark ? 'text-neutral-500' : 'text-gray-400'}`}>
                Digital Agency
              </span>
            </div>
          </a>
          ...
          <div className="hidden lg:flex items-center gap-2.5">
            <button
              ...
              className={`w-10 h-10 rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-110 active:scale-95 ${
                isDark ? 'bg-yellow-500/10 text-yellow-400 hover:bg-yellow-500/20' : 'bg-violet-50 text-violet-600 hover:bg-violet-100'
              }`}
        ...
        >
          ...
          >
            ...
            >
              <span className={`text-xs font-bold uppercase tracking-[0.15em] ${isDark ? 'text-neutral-500' : 'text-gray-400'}`}>
                Navigation
              </span>
              <button
                onClick={toggleTheme}
            ...
            >
              ...
              <p className={`text-center text-xs mt-3 ${isDark ? 'text-neutral-600' : 'text-gray-400'}`}>
