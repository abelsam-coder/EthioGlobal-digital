...
const projects = [
  {
    ...
    images: [
      { src: '../assets/samri collection.png', label: 'Website' },
      { src: '../assets/erp system.png', label: 'ERP System' },
      { src: '../assets/e-commerce.png', label: 'E-Commerce' },
    ],
